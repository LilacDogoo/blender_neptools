...
import nep_tools
from nep_tools import import_to_blender, binary_file_utils
from nep_tools.matrix4f import Matrix4f
            ...
            for current_bone_index in range(model.bones.count):  # BONE DATA BLOCK
                ...
                for current_bone_attribute in range(bone_attribute_count):
                    ...
                    if bone_attribute_type == 0x5B:  # Type 91 # Bone Attibute: Transforms (Transforms are relative to parent)
                        ...
                        if nep_tools.debug: print("      Bone Attribute Type 0x5C == 92  Shape Keys  @ %s" % hex(bone_attribute_offset_array[current_bone_attribute]).rjust(6))
